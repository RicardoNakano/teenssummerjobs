...
export default function ProfileConfig({ onSaved }: { onSaved?: () => void }) {
  ...
  return (
    <div style={{ border: '1px solid rgba(204, 204, 204, 0.3)', padding: '25px', borderRadius: '8px', marginBottom: '30px', maxWidth: '500px', marginLeft: 'auto', marginRight: 'auto', backgroundColor: 'rgba(255, 255, 255, 0.9)', color: '#333' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
        <label style={{ fontSize: '1.1em' }}>
          ...
          <input 
            ...
            style={{ width: 'calc(100% - 22px)', marginTop: '8px', padding: '12px 10px', fontSize: '1em', borderRadius: '5px', border: '1px solid #ccc', backgroundColor: '#fff', color: '#222' }} 
          />
        </label>
        <label style={{ fontSize: '1.1em' }}>
        ...
        <label style={{ fontSize: '1.1em' }}>
          ...
          <input 
            ...
            disabled 
            style={{ width: 'calc(100% - 22px)', marginTop: '8px', padding: '12px 10px', fontSize: '1em', borderRadius: '5px', border: '1px solid #ccc', backgroundColor: '#e9ecef', color: '#495057' }} 
          />
        </label>
        <button 
...
function PhoneRegisterPageInline({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div style={{ maxWidth: '450px', margin: '0 auto', border: '1px solid #ddd', padding: '25px', borderRadius: '8px', backgroundColor: 'rgba(255, 255, 255, 0.95)' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
        <input 
          ...
          placeholder="+15551234567" 
          style={{ width: 'calc(100% - 22px)', padding: '12px 10px', fontSize: '1em', borderRadius: '5px', border: '1px solid #ccc', backgroundColor: '#fff', color: '#222' }} 
        />
